  ...
  return (
    <div className="container">
      ...
      <svg
          ...
          className="img1 w-25 py-2 m-auto mt-5 "
          viewBox="0 0 513 294"
        ...
        {data.map((item) => (
          <div className="col-md-4  " key={item.number}>
            <Link to={`/quran/${item.number}`}>
              {" "}
              <div
                className="sora-main p-1 border"
                onClick={() => setSora(item)}
              >
                <div className="  flex px-2">
                  <div className="flex fw-bold p-2 ayat">
                    <div className="mx-2 fs-3">آيات</div> {item.numberOfAyahs}
                  </div>
                  <Box flexGrow={1} />

                  <Typography
                    textAlign={"end"}
                    className="py-2 mx-3 fw-bold font"
                  >
                    {item.name}
                  </Typography>
                  <Avatar
                    className="avatar"
                    sx={{ width: "40px", height: "40px", color: "inherit" }}
                  >
                    {item.number}
                  </Avatar>
                </div>
